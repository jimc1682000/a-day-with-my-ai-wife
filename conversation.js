const conversationData = [
  ...
  // 比喻的誤區
  { type: 'section', text: '把 AI 當老婆？小心這些誤區' },
  { type: 'narration', text: '「老婆」的比喻很好懂，但有些地方會讓人誤解：' },
  { type: 'table', headers: ['老婆的特質', 'AI 的實際情況', '風險'], rows: [
    ['記得你', '每次 session 都是新的', '以為 AI「認識你」，省略重要脈絡'],
    ['會成長', '不會從互動中學習（對你個人）', '期待 AI 越來越懂你，但它不會'],
    ['有責任感', '出事了 AI 不負責，你要負責', '把責任推給「AI 做的」'],
    ['在乎你', '不在乎，只是在執行指令', '過度信任、情感依賴'],
    ['會反對你', '傾向順從，較少 push back', '你說什麼都「好」，缺乏制衡']
  ]},
  { type: 'tip', title: '💡 所以這比喻該怎麼用？', content: '相處方式學老婆：耐心溝通、適時糾正、偶爾哄一下\n但別忘了：她說的要驗證、出事你要扛、她不記得上次聊什麼' },
